...
{
    public class SolutionDomainCompetenceProfile : Profile
    {
        public SolutionDomainCompetenceProfile()
        {
           
            CreateMap<SolutionDomainCompetence, SolutionDomainCompetenceViewModel>()
               .ForMember(sldcm => sldcm.SolutionDomainName, sldc => sldc.MapFrom(sldc => sldc.SolutionDomain.Name))
               .ForMember(sldcm => sldcm.CompetenceName, sldc => sldc.MapFrom(sldc => sldc.Competence.Name)).ReverseMap();
            CreateMap<SolutionDomainCompetence, CreateSolutionDomainCompetenceViewModel>().ReverseMap();
