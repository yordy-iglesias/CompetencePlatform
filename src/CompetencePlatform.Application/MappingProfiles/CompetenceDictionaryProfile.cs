...
{
    public class CompetenceDictionaryProfile : Profile
    {
        public CompetenceDictionaryProfile()
        {
            CreateMap<CompetenceDictionary, CompetenceDictionaryViewModel>().ReverseMap();
            CreateMap<CompetenceDictionary, CreateCompetenceDictionaryViewModel>().ReverseMap();
