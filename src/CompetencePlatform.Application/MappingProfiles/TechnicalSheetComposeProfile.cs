...
{
    public class TechnicalSheetComposeProfile : Profile
    {
        public TechnicalSheetComposeProfile()
        {
            ...
            CreateMap<TechnicalSheetCompose, CreateTechnicalSheetComposeViewModel>().ReverseMap();
        }
    }
}
