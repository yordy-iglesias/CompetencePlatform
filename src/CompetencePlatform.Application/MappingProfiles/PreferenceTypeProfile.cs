...
{
    public class PreferenceTypeProfile : Profile
    {
        public PreferenceTypeProfile()
        {
          
            CreateMap<PreferenceType, PreferenceTypeViewModel>().ReverseMap();
            CreateMap<PreferenceType, CreatePreferenceTypeViewModel>().ReverseMap();
