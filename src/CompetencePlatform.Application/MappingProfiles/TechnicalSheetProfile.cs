...
{
    public class TechnicalSheetProfile : Profile
    {
        public TechnicalSheetProfile()
        {
          
            CreateMap<TechnicalSheet, TechnicalSheetViewModel>()
               .ForMember(tshcm => tshcm.SolutionDomainName, tsc => tsc.MapFrom(tsc => tsc.SolutionDomain.Name)).ReverseMap();
            
            CreateMap<TechnicalSheet, CreateTechnicalSheetViewModel>().ReverseMap();
        }
    }
}
